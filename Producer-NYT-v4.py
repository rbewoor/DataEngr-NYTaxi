...
maxRows2Read = 5000                            # Specify the maximum number of rows to read from the csv
rowsReadcount = 0
...
boundUpperPUDatetime = '2018-06-02 00:00:00'   # the pickup datetime from csv to be lower than this
with open(fileLocation, "r") as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=",")
    for row in csv_reader:
        rowsReadcount = rowsReadcount + 1
#        print(f'Processing row number {rowsReadcount}')
