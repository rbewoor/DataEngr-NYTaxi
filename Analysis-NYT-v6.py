# -*- coding: utf-8 -*-
"""
Created on Sat Jan  5 12:50:07 2019
...
plotDF['c2TtlPsngrsPerHour'].plot(kind='bar', width = 0.3, figsize=(15,5), ax=ax20, color='g',
                                  title='Hourwise: #TotalPass and Avg Pass/Trip', legend=True)
plotDF['c3AvgPsngrsPerTripHour'].plot(secondary_y=True, ax=ax20, color='b', linewidth=1.0, legend=True)
...
plotDF['c15AvgDistPerTripPerHour'].plot(kind='line', linewidth = 1.0, figsize=(15,5), ax=ax40, color='g', label='Avg Dist/Trip',
...
plotDF['c13AvgFarePerTripPerHour'].plot(secondary_y=True, ax=ax40, color='b', linewidth=1.0, marker="X", ms=8, style='--',
                                    label='Avg Fare/Trip', legend=True)
